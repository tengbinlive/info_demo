...
*/
public class ConfigDao extends AbstractDao<ConfigDO, Long> {

    public static final String TABLENAME = "Config";

    /**
     * Properties of entity ConfigDO.<br/>
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_Config_KEY ON Config" +
                " (KEY);");
    }
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ConfigDO entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ConfigDO readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ConfigDO entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ConfigDO entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ConfigDO entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
