...
import com.touyan.investment.hx.photoview.PhotoView;
import com.touyan.investment.hx.task.LoadLocalBigImgTask;
 ...
 * 
 */
public class ShowBigImage extends AbsActivity {
	private static final String TAG = "ShowBigImage"; 
	private ProgressDialog pd;
	private PhotoView image;
	private int default_res = R.drawable.mini_avatar_shadow;
	...
	public void EInit() {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.mini_avatar_shadow);
