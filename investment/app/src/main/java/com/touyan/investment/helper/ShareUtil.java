...
public class ShareUtil {
    ...
    public Platform.ShareParams getParams(String title, String contents, String url, Bitmap icon) {
    ...
    public void showShareView(Context context, final Platform.ShareParams module) {
        if(mBottomView!=null){
            mBottomView.showBottomView(true);
            return;
        }
        mBottomView = new BottomView(context, R.style.BottomViewTheme_Defalut, R.layout.bottom_share_view);
        ...
        share_weixin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mBottomView.dismissBottomView();
                sendShare(PlatformEnum.WEIXIN, module);
            }
        });
     ...
     * @param type
     */
    public void sendShare(PlatformEnum type, ShareParams module) {
        if (module == null) {
            return;
        }
        switch (type) {
